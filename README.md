...
Access the dashboard at the following urls:
- prod: https://eresearch-dashboard.connect.amazon.auckland.ac.nz/
- test: https://eresearch-dashboard.connect.test.amazon.auckland.ac.nz/
- dev: https://eresearch-dashboard-dev.connect.test.amazon.auckland.ac.nz/
